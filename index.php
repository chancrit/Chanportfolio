...
<head>
    ...
    <title>Christian Earl's Portfolio</title>
...
<body>
    <div class="animsition">
        ...
        <div class="menu">
            ...
            <ul class="menu-list right-boxed">
                ...
                <li data-menuanchor="page2">
                    <a href="#page2">What I DO</a>
                </li>
                <li data-menuanchor="page3">
                    <a href="#page3">Resume</a>
                </li>
                <li data-menuanchor="page4">
                    <a href="#page4">Applications</a>
                </li>
            ...
            <div class="menu-footer right-boxed">
                ...
                <div class="copy"><a href="https://web.facebook.com/chistyan.kan">Christian Earl Siong</a></div>
            </div>
        </div>
        ...
        <header class="navbar boxed">
            ...
            <a class="brand" href="#">
                <img class="brand-img" alt="" src="images/CS 33X33.png">
                <div class="brand-info">
                    <div class="brand-name">Christian</div>
                    <div class="brand-text">Siong</div>
                </div>
            </a>
            ...
            <div class="contacts d-none d-md-block">
                ...
                <div class="contact-item">
                    <a href="https://mail.google.com/mail/u/2/?ogbl#inbox?compose=new"><span class="__cf_email__"
                            data-cfemail="d0b3bfbea4b1b3a490a2bfb2b5a2a4feb3bfbd">chancrit17@gmail.com</span></a>
                </div>
            </div>
        </header>
        <div class="copy-bottom white boxed">© Christian 2024.</div>
                            ...
                            <div class="boxed boxed-inner">
                                ...
                                <div class="boxed">
                                    <div class="container">
                                        <div class="intro">
                                            <div class="row">
                                                <div class="col-md-8 col-lg-6">
                                                    <p class="subtitle-top">Welcome To<br>Christian Design Studio</p>
                                                    <h1 class="display-2 text-white">
                                                        <span class="text-warning">Hello</span>
                                                        <span style="text-shadow: 2px 2px 5px black;">I am</span>
                                                        <br>
                                                        <span style="text-shadow: 2px 2px 5px black;">Christian</span>.
                                                    </h1>
                                        ...
                                        <a href="www.facebook.com" class="button-33">View My Designs</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-xl-5">
                                                    <h2 class="title-uppercase"> <span class="text-primary">the
                                                            best</span> applications i use in Designing</h2>
                                                            The best applications I use in designing are Photoshop and Illustrator. Photoshop excels in photo editing and
                                                            manipulation, providing powerful tools for creativity. Illustrator, on the other hand, is perfect for creating vector
                                                            graphics and illustrations with precision and scalability.
                                    ...
                                    <div class="container">
                                        <div class="intro">
                                            <div class="row row-resume">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="col-resume">
                                                        <h4 class="title-uppercase">No Resume</h4>
            ...
            <div data-anchor="page4" class="pp-scrollable section section-4">
                <div class="scroll-wrap">
                    <div class="scrollable-content">
                        <div class="vertical-centred">
                            <div class="boxed boxed-inner">
                                <div class="vertical-title text-white d-none d-lg-block"><span>Applications</span></div>
                                <div class="boxed">
                                    <div class="container">
                                        <div class="intro">
                                            <h2 class="title-uppercase text-white">Best Applications to use in Designing</h2>
                                            <div class="row row-partners">
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt="" src="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/photoshop_5968520.png">
                                                        Adobe Photoshop
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/illustrator_5968472.png">
                                                        Adobe Illustrator
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/photoshop-lightroom-classic_5968510.png">
                                                        Adobe Lightroom
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                                    <div class="partner-inner"><img alt="" src="images/partners/indesign_5968482.png">
                                                        Adobe InDesign
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-md-4 col-xl-3 col-partner">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <section class="contact-address">
                                                        ...
                                                        <h3><span class="phone">+639555147689</span></h3>
                                                    </section>
                                                </div>
                                                <div class="col-md-6">
